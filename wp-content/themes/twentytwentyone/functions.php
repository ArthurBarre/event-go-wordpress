...
function twenty_twenty_one_scripts()
{
    ...
    if (has_nav_menu('primary')) {
        wp_enqueue_script('twenty-twenty-one-primary-navigation-script', get_template_directory_uri().'/assets/js/primary-navigation.js', array('twenty-twenty-one-ie11-polyfills'),
            wp_get_theme()->get('Version'), true);
    }

    // Responsive embeds script.
    wp_enqueue_script('twenty-twenty-one-responsive-embeds-script', get_template_directory_uri().'/assets/js/responsive-embeds.js', array('twenty-twenty-one-ie11-polyfills'),
        wp_get_theme()->get('Version'), true);
}
...
function twentytwentyone_customize_preview_init()
{
    ...
    wp_enqueue_script('twentytwentyone-customize-preview', get_theme_file_uri('/assets/js/customize-preview.js'),
        array('customize-preview', 'customize-selective-refresh', 'jquery', 'twentytwentyone-customize-helpers'), wp_get_theme()->get('Version'), true);
}
...
{
    wp_enqueue_style('card', get_template_directory_uri().'/assets/css/card.css');
}
...
{
    add_menu_page('Changer le titre Admin', 'Footer Text', 'manage_options', 'custom_footer_text', 'change_footer_text', 'dashicons-awards', 66);
}
...
function mon_reglage()
{
    ...
    add_settings_field('mon_champs_de_reglage_custom', 'Mon Champs de reglage custom', 'callback_display_setting_field', 'custom_footer_text', 'section_de_reglage', array(
...
function callback_display_setting_field($args)
{
  ...
  <input name='action' type='hidden' value='post_un_truc'>
    <?php
}
...
function change_footer_text()
{
  ...
  <div class="wrap">
    ...
    <form action='<?php echo esc_url(admin_url('admin-post.php')); ?>' method='post'>
        ...
        wp_nonce_field('what-who_which', 'securite_nonce');
        submit_button();
        ?>
    </form>
  </div>
